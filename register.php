...
<h3><u>HERO'S</u></h3><h6>Sign-In PLease</h6>
<hr>
<form action="" method="post">
  ...
  <button type="submit" class="form-control" id="submit-button"  style="background-color:#8a242bd0; color:white;">Sign in</button>
</form>
</div>
